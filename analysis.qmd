...
library(readxl)
library(knitr)
literates_wo_diploma_dataset <- readxl::read_excel("LiteratesWODiplomas_Change.xlsx")
kable(
...
library(readxl)
library(knitr)
LSS_Dataset <- readxl::read_excel("LiteratesWODiplomas_Change.xlsx")
kable(
  head(LSS_Dataset, 15),
  format = "html",
  caption = "Literates Without Diploma Percentage Change",
...
### **Upper Secondary School Graduates** {toc-text="Illiterates"}
```{r}
#| echo: false
...
### University Graduates {toc-text="Illiterates"}
```{r}
#| echo: false
...
### **Master and Doctorate Graduates** {toc-text="Illiterates"}
```{r}
#| echo: false
...
library(readxl)
library(knitr)
UK_Dataset <- readxl::read_excel("Unknowns_Change.xlsx")
kable(
  head(MD_Dataset, 15),
  format = "html",
